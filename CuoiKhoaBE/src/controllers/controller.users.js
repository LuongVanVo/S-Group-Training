...
import servicesMembers from '../services/services.users.js'
...
const registerMember = async (req, res) => {
    try {
        ...
        const newMember = await servicesMembers.registerMemberService(name, email, password, role)
...
const deleteUser = async (req, res) => {
    try {
        ...
        const deleteUser = await servicesMembers.deleteUser(userId);
        return res.status(200).json({
            "success": true,
            "message": "Member registered successfully",
            "data": deleteUser
...
const updateProfileInfo = async (req, res) => {
    try {
        ...
        const updateData = await servicesMembers.updateProfileMemberService(memberData);
        if (!updateData) {
            return res.status(400).json({
                "success": false,
